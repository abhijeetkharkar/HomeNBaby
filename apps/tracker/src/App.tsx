            ...
            <Container maxWidth="lg">
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Box sx={{ display: { xs: 'none', sm: 'flex' }, alignItems: 'center', gap: 2 }}>
                  <HeaderStats />
                  <Typography variant="body2" sx={{ cursor: 'pointer', opacity: 0.8, '&:hover': { opacity: 1 } }} onClick={signOut}>
                    Logout
                  </Typography>
                </Box>
              </Box>
              <Box sx={{ display: { xs: 'flex', sm: 'none' }, justifyContent: 'space-between', mt: 1 }}>
                <HeaderStats />
                <Typography variant="body2" sx={{ cursor: 'pointer', opacity: 0.8, '&:hover': { opacity: 1 } }} onClick={signOut}>
                  Logout
                </Typography>
