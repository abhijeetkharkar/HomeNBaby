...
STACK_NAME="plants-stack-$ENVIRONMENT"
...
echo -e "\033[0;36mBuilding Plants frontend...\033[0m"
...
echo -e "\033[0;32mPlants app deployed successfully to https://plants.abhijeetkharkar.com\033[0m"
