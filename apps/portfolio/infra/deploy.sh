...
STACK_NAME="portfolio-stack-$ENVIRONMENT"
...
echo -e "\033[0;36mBuilding Portfolio frontend...\033[0m"
...
echo -e "\033[0;32mPortfolio deployed successfully to https://portfolio.abhijeetkharkar.com\033[0m"
