...
STACK_NAME="reminders-stack-$ENVIRONMENT"
...
echo -e "\033[0;36mBundling Reminders Lambda code...\033[0m"
mkdir -p "$DIST_DIR"
(
  cd "$APP_ROOT"
  npx esbuild reminder-lambda.js --bundle --platform=node --target=node20 "--outfile=$DIST_DIR/index.js"
  cd "$DIST_DIR"
...
echo -e "\033[0;32mReminders service deployed successfully\033[0m"
