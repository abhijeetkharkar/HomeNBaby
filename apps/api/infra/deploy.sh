...
STACK_NAME="api-stack-$ENVIRONMENT"
...
echo -e "\033[0;36mBundling API Lambda code...\033[0m"
mkdir -p "$DIST_DIR"
(
  cd "$APP_ROOT"
  npx esbuild lambda.js --bundle --platform=node --target=node20 "--outfile=$DIST_DIR/index.js"
  cd "$DIST_DIR"
...
echo -e "\033[0;32mAPI deployed successfully to https://api.abhijeetkharkar.com\033[0m"
